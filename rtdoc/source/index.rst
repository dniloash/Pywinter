...
**Here you can find some examples about selecting Geo-parameters properly** > :download:`examples <https://github.com/dniloash/Pywinter/blob/master/examples/data_lat_lon_example.ipynb>`
