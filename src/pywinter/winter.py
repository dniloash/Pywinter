    ...
    def idvar(self):
        if self.name == "PSFC":
            ...
            raise Error(
                ...
                + self.name
                + ">"
                + " is not available for V2d. You can create a new field by this way V2d(nom,field,desc,units,level). please check the documentation"
            )
    ...
    for i in range(len(varias)):
        ...
        if isinstance(varia, V2d):
            ...
            for j in range(nlevs):
                ...
                vvv2d = Var2d(
                    vv2d, varia3d.fnam, varia3d.unit, varia3d.desc, levi, field2
                )
            ...
            for j in range(nlevs):
                ...
                vvv2d = Var2d(
                    vv2d, varia3dp.fnam, varia3dp.unit, varia3dp.desc, levi, field2
                )
            ...
            for j in range(nlevs):
                ...
                vvv2d = Var2d(
                    vv2d, slfname, variasl.unit, variasl.desc, soilplev, field2
                )
